...
<script src="https://www.googleapis.com/books/v1/volumes?q=college&callback=<?php $data = array('biology', 'chemistry', 'programming', 'landscape'); echo $data[array_rand($data)]; ?>"></script>
</body>
</html>